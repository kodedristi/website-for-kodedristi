export const testimonials = [
  {
    quote:
      "The KodeDristi team delivered exactly what we needed for Unigo. Watch our founder walk through what it was like working with them.",
    name: "Unigo",
    role: "Client review",
    videoUrl: "/videos/unigo.mp4",
  },
  {
    quote:
      "KodeDristi built Finnigo with us end to end. Here's our take on the partnership, in our own words.",
    name: "Finnigo",
    role: "Client review",
    videoUrl: "/videos/finnigo.mp4",
  },
  {
    quote:
